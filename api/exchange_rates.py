...
def get_exchange_rates():
    ...
    durante el despliegue en Vercel, lo cual es útil para desarrollo o si el archivo falta.
    """
    try:
        if not os.path.exists(EXCEL_RATES_FILE_PATH):
            ...
            # Fallback a datos de ejemplo (hardcodeados) si el archivo no se encuentra
